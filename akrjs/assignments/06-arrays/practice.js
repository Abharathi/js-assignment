...
//     //=> false
//
var containsNTimes = function (num,val,arr) {
	var c=0;
	for(i=0;i<arr.length;i++){
		if(arr[i]==val){
			c=c+1;
...
console.log(containsNTimes(5, true, [ true, true, true, true, true ]));
...
console.log(atLeastOneEven([ 3, 5, 1, 7, 9 ]));
